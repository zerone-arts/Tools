...
export default function CalculatorAppPage({}) {
  ...
  return (
    <div className=" w-full h-full max-lg:flex hidden  p-5 items-center justify-center text-gray-100 relative  ">
      <div className="w-[280px] h-[500px]  relative group overflow-hidden rounded-2xl shadow-2xl border dark:border-none bg-zinc-900/50 dark:bg-zinc-900 ">
        <div
