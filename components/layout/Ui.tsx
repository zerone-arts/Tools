  ...
  return (
    ...
    >
      ...
      <div className="absolute ml-[50px] h-screen opacity-0 group-hover:opacity-100 duration-300 text-sm font-light">
        <div className="mt-3 flex ml-[14px] ">
          <div
            className={`w-[100px] h-9 flex items-center rounded-sm  duration-300  ${
              selectMenu === "/" ? "text-white" : "text-gray-500"
            }`}
          >
            Rotion
          </div>
        ...
        <ul className="mt-5  ml-[14px] flex flex-col  justify-center gap-5 ">
          <li
            className={`w-[100px] h-9 flex  items-center rounded-sm duration-300 text-white  ${
              selectMenu === "/memo" ? "text-white" : "text-gray-500"
            }`}
          >
            <h1>Memo</h1>
          </li>
          <li
            className={`w-[100px] h-9 flex  items-center rounded-sm duration-300 text-white  ${
              selectMenu === "/calendar" ? "text-white" : "text-gray-500"
            }`}
          >
            <h1>Calendar</h1>
          </li>
          <li
            className={`w-[100px] h-9 flex  items-center rounded-sm duration-300 text-white ${
              selectMenu === "/weather" ? "text-white" : "text-gray-500"
            }`}
          >
            <h1>Weather</h1>
          </li>
          <li
            className={`w-[100px] h-9 flex items-center rounded-sm duration-300 text-white  ${
              selectMenu === "/calculator" ? "text-white" : "text-gray-500"
            }`}
          >
            <h1>Calculator</h1>
          </li>
        ...
        <div className="absolute  ml-[14px] bottom-[21px] w-full flex flex-col gap-3 ">
          <div
            className={`w-[100px] h-9 flex items-center rounded-sm duration-300 text-white  ${
              selectMenu === "/setting" ? "text-white" : "text-gray-500"
            }`}
          >
            <p>Setting</p>
          </div>
          <div className="w-[100px] h-9 flex  items-center  duration-300 text-white">
            ZERONE
          </div>
        </div>
      </div> */}
      ...
      <div className="w-full border-2 flex flex-col justify-between ">
        <div>
          <div className="bg-yellow-300 w-full h-[60px]"></div>
          <div className="bg-blue-300 w-full h-[300px]">
            <ul>
              <li className="border-2 border-black h-[50px] flex gap-2">
                <div className="w-[50px] border-2 border-red-500 flex-shrink-0">
                  h2
                </div>
                <div className="w-[100px] border-2 border-black opacity-0 group-hover:opacity-100 duration-500 ease-out">
                  test
                </div>
              </li>
            </ul>
        ...
        <div className="bg-red-300 w-full h-[50px]"></div>
      </div>
    </div>
  );
}
